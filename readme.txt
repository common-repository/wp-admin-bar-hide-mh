...
Contributors: MH Arif
Tags: wp admin bar, hide admin bar, hidden admin bar, wordpress admin bar
Requires at least: 3.0
Tested up to: 5.2.4
Stable tag: trunk

WP Admin Bar Hide in WordPress 3.0+

== Description ==

WP Admin Bar Hide MH plugin hide the frontend admin bar in WordPress 3.1+, credits to <a href="http://yoast.com/disable-wp-admin-bar/">Yoast</a>, and <a href="https://systmweb.com">Shelby Denike</a>. If you want to use the WP Admin Bar Hide plugin and love it hungout with me, <a href="https://www.softgudam.com/">contact in softgudam</a>.
